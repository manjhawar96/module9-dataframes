...
opp.huskies <- husky.games.2015$opponent
...
husky.games.2016 <- husky.games.2015 <- read.csv('data/huskies_2016.csv', stringsAsFactors=FALSE)
best.game <- MostYardsScore(husky.games.2016)